const PrivacyPolicy = () => {
    return (
        <div>
            <h2 className="text-lg font-semibold">Privacy Policy Promise</h2>
            <p className="text-base">While information is the cornerstone of our ability to provide superior service, our most important asset is our clients’ trust. Keeping client information secure, and using it only as our clients would want us to, is a top priority for all of us at Journey Travel & Tours. Here then, is our promise to our individual customers:
                ...
                <li>We will always maintain control over the confidentiality of our customer information.</li>
                <li>We may, however, share customer information with reputable companies when a customer has expressed an interest in their service or product. Please note that this Privacy Policy does not apply to these other companys use of customer information.</li>
