...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#EBF3FB] h-[88px] sticky top-0 z-50 flex items-center">
      <div className="w-[1170px] mx-auto flex items-center justify-between">
        ...
        <div className="w-[82%] flex justify-between">
          ...
          <div className="w-48 flex items-center">
            <button className="old-logo-color px-6 py-4 rounded-xl font-bold text-white">Become an Agent</button>
          </div>
